...
useEffect(()=>{
   axios.get(`https://fakestoreapi.com/products/${url_id.id}`).then((data1)=>{
  
    changepro(data1.data)
   })
 ...
 <div className="container-fluid pb-5">
  <div className="row px-xl-5">
    <div className="col-lg-5 mb-30">
      ...
      >
        <div className="carousel-inner bg-light">
          ...
          <Button onClick={handleOpen}>
            <img className="w-100 h-100" src={pro.image} alt="Image"/></Button>
            <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
        <img className="w-100 h-100" src={pro.image} alt="Image"/>
</Box></Modal>
          </div>
    ...
    <div className="col-lg-7 h-auto mb-30">
      <div className="h-100 bg-light p-30">
        ...
        <h3 className="font-weight-semi-bold mb-4">{pro.price}</h3>
        <p className="mb-4">
         {pro.description}
        </p>
        <div className="d-flex mb-3">
